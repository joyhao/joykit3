...
<script>
  ...
  import {getData, addClass, removeClass} from '../../../static/js/dom'
  ...
  export default {
    ...
    methods: {
      ...
      addActiveCls(e) {  // 左侧li点击添加class
        addClass(e.currentTarget, ACTIVE_CLS)
      },
      removeActiveCls(e) {  // 左侧li点击移除class
        removeClass(e.currentTarget, ACTIVE_CLS)
      },
      _calculateHeight() { // 计算数据内容高
      ...
      _scrollTo(index) { // 点击右侧按钮 左侧内容滚动
        ...
        this.$refs.indexList.scrollToElement(this.$refs.listGroup[index], 500)
    ...
    watch: {
      ...
      scrollY(newY) {
        ...
        for (let i = 0; i < listHeight.length - 1; i++) {
          ...
          // console.log(height2_1,height2_2)
          if (-newY >= height1 && -newY < height2) {
            this.currentIndex = i
            console.log(listHeight.length - i)
